...
# Auto cek hp
# "$(echo $(getprop ro.product.manufacturer) | tr '[:lower:]' '[:upper:]') $(getprop ro.product.model) | Android: $(getprop ro.build.version.release)"
...
# footer text
owner_info=" @galangpurnama.my.id"
footer_text=" Screenshot By Galang Purnama"
#footer style
#xshot
footer_xy="+0+30"
footer_xy_time="+0+20"
...
${b}
                   Mempercantik screenshot anda
                           Owner : Galang Purnama"
}
autoshot() {
  clear
  header
  echo -e "${r}[${y}${count}${r}] Galang Purnama"
